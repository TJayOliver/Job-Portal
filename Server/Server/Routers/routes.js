...
routes.put('/api/articles-update/:id',upload.single('image'), ArticleUpdate);
...
routes.put('/api/graduatesjobs-update/:id', upload.single('image'), GraduateJobsUpdate);
...
routes.put('/api/internships-update/:id',upload.single('image'), InternshipsUpdate);
...
routes.put('/api/scholarships-update/:id',upload.single('image'), ScholarshipsUpdate);
