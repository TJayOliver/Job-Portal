class ScholarshipController {
    ...
    async readFeaturedScholarship (req, res) {
        try {
            ...
            res.status(201).json({message:'Successfully retrieved', data : scholarship});
        } catch (error) {
    ...
    async updateScholarship (req, res) {
        try {
            ...
            return res.status(201).json({message:'Successfully Updated', data : scholarship});
        } catch (error) {
            console.error('controller {edit scholarship}', error.message);
            res.status(500).json({message:'Internal Server Error'})
        }
    ...
    async deleteScholarship (req, res) {
        try {
            ...
            return res.status(201).json({message:'Successfully Deleted', data : scholarship});
        } catch (error) {
