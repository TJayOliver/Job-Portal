            ...
            <div className=' flex flex-col gap-2'>
                ...
                <div className=' flex items-center gap-2'>
                    ...
                    <div>
                        ...
                        <p>help individuals acquire information, skills<br></br> and experience necessary to identify<br></br>career options.</p>
                    </div>  
                </div>
            </div>
            ...
            <div className=' flex flex-col gap-2'>
                ...
                <div className=' flex items-center gap-2'>
                    ...
                    <div>
                        ...
                        <p>By promoting scholarship opportunities all<br></br>year long,we provide direction and help to <br></br>students in need of financial aid.</p>
                    </div>  
                </div>
            </div>
            ...
            <div className=' flex flex-col gap-2'>
                ...
                <div className=' flex items-center gap-2'>
                    ...
                    <div>
                        ...
                        <p>To locate your next career use our job search<br></br>move,engine to browse millions of job listings.</p>
                    </div>  
                </div>
            </div>
