            ...
            <ul className=" flex gap-4">
                {
                    pageNumbers.map((page, id) =>(
                        <li key={id} onClick={()=>{setCurrentPage(page)}} className={page == currentPage ? className : `bg-gray-200 p-3 hover:bg-gray-300 hover:duration-100 hover:ease-out cursor-pointer rounded-md ` }>   {page}
                        </li> 
                    ))
                }
