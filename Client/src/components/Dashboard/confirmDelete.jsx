            ...
            <div className={`bg-white drop-shadow-md h-96 md:h-64 md:w-[35rem] rounded-md flex flex-col items-center justify-center p-4 gap-4 relative duration-300 ease-in ` }>
               ...
               { done ? 
                    <div className="items-center justify-center flex flex-col gap-2">
                        ...
                        <button onClick={handleDisplay} className="  h-10 p-2 rounded-md w-full bg-blue-600 hover:text-white hover:border-none hover:duration-300 hover:ease-in">DONE</button> 
                    </div> 
                    :
                    <div className="items-center justify-center flex flex-col gap-2">
                        {/* Caution */}
                        ...
                        <div className=" w-full flex flex-col md:flex md:flex-row gap-2">
                            <button onClick={handleDisplay} className=" border border-black h-10 p-2 rounded-md w-full hover:bg-blue-600 hover:text-white hover:border-none hover:duration-300 hover:ease-in">CANCEL</button> 
