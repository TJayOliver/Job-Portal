...
const ScholarshipForm = ({className}) =>{
    ...
    return(
        <>
        {submitted && <SubmittedBox successMessage='Scholarship Opportunity Submitted'/> }
        <form onSubmit={Submit} className={className}>
            
            <div className=" font-semibold text-2xl text-center md:sticky md:top-0 p-3 bg-white">Scholarship Panel</div>
