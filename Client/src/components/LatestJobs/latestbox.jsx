...
const LatestBox = ({image, salary, location, company, duration, position}) =>{
    return(
        <div className=' flex-none rounded-md bg-white h-[24rem] w-64 drop-shadow-md'>
            <img src={image || one} loading='lazy' alt='Job Flyer' className=" h-44 w-80 bg-white object-cover rounded-t-2xl p-2 bg-center duration-100" />
            ...
            <div className=' flex justify-center gap-4'>
                ...
                <div className=' bg-teal-600 text-white py-2 px-3 rounded-md cursor-pointer'>Apply</div>
            </div>
        </div> 
    )
}
