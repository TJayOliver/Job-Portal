const Footer = ({onClick}) =>{
    ...
    return(
        <section className=" h-full p-4 flex flex-col justify-center text-md bg-black/90 text-white/80">
            ...
            <div className="flex flex-col justify-center m-auto max-w-5xl w-full gap-10">
                <div className="flex justify-between items-center ">
                    ...
                    <div className="flex items-center gap-1">
                        <div onClick={onClick}role='button' className="p-2 bg-teal-500 rounded-md">Subscribe</div>
                    </div>
                </div>

                <hr></hr>

                <div className="flex gap-8 items-center md:gap-20">
                    {/* about and address */}
