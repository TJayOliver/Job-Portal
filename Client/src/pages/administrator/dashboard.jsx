...
const Dashboard = () =>{
    ...
    return(
        ...
        <div className=" flex flex-col md:flex md:flex-row md:h-screen md:w-full bg-white">
        
            {/* Left side panel */}
            <div className=" sticky top-0 bg-blue-600 whitespace-nowrap w-full md:w-80  z-50">
            ...
            {/* Right Side Panel */}
            <div className=" w-full  md:h-full md:overflow-y-scroll -z-0">
